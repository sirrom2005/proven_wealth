...
class AccountRequestStatement extends StatefulWidget {
  static const String id = "RequestStatement";
  const AccountRequestStatement({super.key});
...
class Page extends State<AccountRequestStatement>{
            ...
            child: SafeArea(
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    Text('Request Statement Coming Soon', style: MyStyles.headerStyle1.copyWith(color: MyColors.red))
                  ],
                )
              ),
            )
